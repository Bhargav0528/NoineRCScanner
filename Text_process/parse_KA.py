...
fields = ['REG DATE', 'CHASSIS NO', 'ENGINE NO', 'OWNERNAME', 'S/W/D OF', 'ADDRESS', 'MODEL', 'BODY', 'WHEEL BASE', 'MFG DATE', 'FUEL', 'REG/FC UPTO', 'TAX UPTO', 'O SL NO', 'MFR', 'CLASS', 'COLOUR', 'NO OF CYL', 'UNLADEN'
